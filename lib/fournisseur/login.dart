...
class InputtField extends StatefulWidget {
  const InputtField({super.key});

  @override
  _InputtFieldState createState() => _InputtFieldState();
}

class _InputtFieldState extends State<InputtField> {
                 ...
                 SizedBox(height: 40,),
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>SignUpfour()));
                        },
                        child: Text(
                          'Sign up',
                          style: TextStyle(
